" Name:        fauxthon.vim
" Author:      Florian Martin <florianfmmartin@gmail.com>
" Webpage:     https://github.com/florianfmmartin/fauxthon
...
let colors_name = "fauxthon"

if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    hi Normal ctermbg=231 ctermfg=233 cterm=NONE guibg=#eeeeee guifg=#121212 gui=NONE
    ...
    hi Constant ctermbg=bg ctermfg=134 cterm=NONE guibg=bg guifg=#0f7ebc gui=NONE
    ...
    hi StatusLine ctermbg=254 ctermfg=134 cterm=bold guibg=#dfdfdf guifg=#0f7ebc gui=bold
    hi StatusLineNC ctermbg=255 ctermfg=242 cterm=NONE guibg=#e4e4e4 guifg=#6c6c6c gui=NONE
    hi TabLine ctermbg=253 ctermfg=242 cterm=NONE guibg=#dadada guifg=#6c6c6c gui=NONE
    hi TabLineSel ctermbg=255 ctermfg=134 cterm=bold guibg=#e4e4e4 guifg=#0f7ebc gui=bold
    hi WildMenu ctermbg=203 ctermfg=231 cterm=NONE guibg=#d75f5f guifg=#eeeeee gui=NONE
    hi VertSplit ctermbg=255 ctermfg=255 cterm=NONE guibg=#e4e4e4 guifg=#e4e4e4 gui=NONE
    ...
    hi CursorLineNr ctermbg=255 ctermfg=134 cterm=NONE guibg=#e4e4e4 guifg=#0f7ebc gui=NONE
    hi Cursor ctermbg=134 ctermfg=233 cterm=NONE guibg=#0f7ebc guifg=#121212 gui=NONE
    hi CursorLine ctermbg=255 ctermfg=NONE cterm=NONE guibg=#e4e4e4 guifg=NONE gui=NONE
    hi SignColumn ctermbg=NONE ctermfg=242 cterm=NONE guibg=NONE guifg=#6c6c6c gui=NONE
    hi Visual ctermbg=254 ctermfg=NONE cterm=NONE guibg=#dfdfdf guifg=NONE gui=NONE
    hi VisualNOS ctermbg=253 ctermfg=NONE cterm=NONE guibg=#dadada guifg=NONE gui=NONE
    hi Pmenu ctermbg=255 ctermfg=242 cterm=NONE guibg=#e4e4e4 guifg=#6c6c6c gui=NONE
    hi PmenuSbar ctermbg=254 ctermfg=NONE cterm=NONE guibg=#dfdfdf guifg=NONE gui=NONE
    hi PmenuSel ctermbg=254 ctermfg=134 cterm=bold guibg=#dfdfdf guifg=#0f7ebc gui=bold
    ...
    hi IncSearch ctermbg=203 ctermfg=231 cterm=NONE guibg=#d75f5f guifg=#eeeeee gui=NONE
    hi Search ctermbg=134 ctermfg=231 cterm=NONE guibg=#0f7ebc guifg=#eeeeee gui=NONE
    hi Directory ctermbg=NONE ctermfg=134 cterm=NONE guibg=NONE guifg=#0f7ebc gui=NONE
    ...
    hi DiffAdd ctermbg=255 ctermfg=28 cterm=NONE guibg=#e4e4e4 guifg=#008700 gui=NONE
    hi DiffChange ctermbg=255 ctermfg=NONE cterm=NONE guibg=#e4e4e4 guifg=NONE gui=NONE
    hi DiffDelete ctermbg=255 ctermfg=124 cterm=NONE guibg=#e4e4e4 guifg=#af0000 gui=NONE
    hi DiffText ctermbg=255 ctermfg=166 cterm=NONE guibg=#e4e4e4 guifg=#d75f00 gui=NONE
    hi helpHyperTextJump ctermbg=bg ctermfg=134 cterm=NONE guibg=bg guifg=#0f7ebc gui=NONE
...
if has('nvim')
    ...
    let g:terminal_color_13 = '#0f7ebc'
